...
window.Modernizr = (function( window, document, undefined ) {
    ...
    if ( !is(_hasOwnProperty, 'undefined') && !is(_hasOwnProperty.call, 'undefined') ) {
      ...
      hasOwnProperty = function (object, property) { /* yes, this can give false positives/negatives, but most of the time we don't care Sobre those */
     ...
     *
     * Additionally, Chrome (desktop) used to lie Sobre its support on this,
    ...
    // Super comprehensive table Sobre all the unique implementations of
